      ...
      <div className="max-w-9xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-9xl mx-auto text-center pb-8">
            <h2 className="font-bold text-8xl font-poppins">
          ...
          <div>
            ...
            <div className="flex justify-center max-w-[11rem] mx-auto mb-8 lg:mb-14 ">
              <div className="relative flex w-full py-1  bg-white rounded-full">
                ...
                >
                  <span
                    className={`absolute inset-0 w-3/5 bg-black rounded-full shadow-sm transform transition duration-150 ease-in-out ${
                      annual ? "translate-x-full" : "translate-x-0"
                    }`}
                  />
                </span>
                <button
                  className={`relative flex-1 text-lg px-3 font-poppins font-bold h-12  ml-1 transition duration-150 ease-in-out ${
                    annual ? "text-black" : "text-white"
                  }`}
                ...
                <button
                  className={`relative flex-1 text-lg px-3 font-poppins font-bold h-12 ml-2 transition duration-150 ease-in-out ${
                    annual ? "text-white" : "text-black"
                  }`}
            ...
            <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none pt-4">
              ...
              >
                <div className="mb-6">
                  <div className="font-poppins text-xl font-bold mb-1">
                    Basic
                  </div>
                  ...
                  <div className="text-gray-500 mb-6">
                    Start building your team and hire the most talented workers
                    in the world.
                  </div>
                  <Link
                ...
                <div className="font-poppins font-bold mb-4">
                  Features include:
                </div>
              ...
              {/* Pricing table 2 */}
              <div
                className="relative flex flex-col h-full p-6 rounded bg-black text-white"
                data-aos="fade-up"
              >
                <div className="mb-6">
                  ...
                  <Link
                    className="btn w-full inline-flex items-center text-black bg-white hover:bg-gray-100 group"
                    href="https://docs.google.com/forms/d/e/1FAIpQLSczBokvaCvrsP-ZNyhOetuy1hMGIYA8-aS5suHVlVBnN6gcLw/viewform"
                  >
                    Schedule A Call
