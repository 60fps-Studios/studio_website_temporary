      ...
      <div className="max-w-6xl lg:max-w-none mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 lg:grid-cols-10 gap-8 py-8 border-t border-blue-500 lg:ml-72">
          ...
          <div className="sm:col-span-12 lg:col-span-2 lg:max-w-xs">
            ...
            <div className="">
              <SparklesText
                text="60fps"
                sparklesCount={8}
                className="text-6xl font-extrabold  font-cabinet-grotesk text-white lg:-ml-[290px] lg:pt-12  "
                data-aos="fade-up"
              />
            </div>
          </div>
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-4 lg:mt-40">
            <h2 className="text-3xl text-gray-100 font-bold uppercase mb-3">
              Essentials
            </h2>
            ...
            <ul className="flex mb-4 md:order-1  md:mb-0 -ml-4 md:-ml-4 lg:ml-1">
              <li>
                <a
                  ...
                  href="https://x.com/60fps_studio"
                  aria-label="Twitter"
                >
                  <img src="./twitterx.svg" alt="" />
                  {/* <svg
              ...
              <li className="ml-2">
                <a
                  className="flex justify-center items-center text-gray-400 hover:text-white transition duration-150 ease-in-out"
                  href="https://www.instagram.com/studio.60fps/"
              ...
              <li className="ml-2">
                <a
                  className="flex justify-center items-center text-gray-400 hover:text-white transition duration-150 ease-in-out"
                  href="https://www.linkedin.com/company/60fps-studio/?viewAsMember=true"
                  aria-label="linkedin"
                >
